...
// Helpers
	...
	// FIRAXIS BEGIN
	// Shutting down an HTTP Downloader can hang during an upstream disconnect. Do it in a background thread.
	class FShutdownHttpDownloaderAsyncTask : public FNonAbandonableTask
	{
	public:
		class FHttpDownload* HttpDownloader;
		FShutdownHttpDownloaderAsyncTask() : HttpDownloader(NULL) {}
		static const TCHAR *Name() { return TEXT("FShutdownHttpDownloaderAsyncTask"); }
		void DoWork();
	};
	// FIRAXIS END
}