...
// FIRAXIS begin: UOnlineGameInterfaceXCOM Setup for Steamworks Lobbies as the source for game creation -ttalley
/**
 * Initialization/Deconstruction of any game interface components
 */
native function bool InitGameInterface();
native function bool PostInitGameInterface();
native function bool DestroyGameInterface();
// FIRAXIS end: UOnlineGameInterfaceXCOM Setup for Steamworks Lobbies as the source for game creation -ttalley
 ...
 */
function SetupGameBootInvitation(optional bool bIgnoreBootCheck=false);
