//---------------------------------------------------------------------------------------
//  *********   FIRAXIS SOURCE CODE   ******************
//  FILE:    UIScreenListener_UICustomize_TLE
...
class UIScreenListener_UICustomize_TLE extends UIScreenListener;
...
{
	if( BodyPart.DLCName == 'TLE' )
	{
		return class'UIUtilities_Text'.static.InjectImage( "xcom_icon", 26, 26, -4) $ " ";
	}
	return "";
