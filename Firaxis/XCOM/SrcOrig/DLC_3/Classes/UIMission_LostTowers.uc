//---------------------------------------------------------------------------------------
//  FILE:    UIMission_LostTowers.uc
//  AUTHOR:  Joe Weinhoffer
//           
//---------------------------------------------------------------------------------------
//  Copyright (c) 2016 Firaxis Games, Inc. All rights reserved.
//---------------------------------------------------------------------------------------
class UIMission_LostTowers extends UIMission;
...
simulated function InitScreen(XComPlayerController InitController, UIMovie InitMovie, optional name InitName)
{
	...
	FindMission('MissionSource_LostTowers');

	if (CanTakeMission())
	{
		NewGameState = class'XComGameStateContext_ChangeContainer'.static.CreateChangeState("Trigger Central Lost Towers Mission Dialogue");
		`XEVENTMGR.TriggerEvent('OnViewLostTowersMission', , , NewGameState);
...
simulated function BuildMissionPanel()
{
	...
	LibraryPanel.MC.QueueString(""); //class'UIUtilities_Text'.static.CapsCheckForGermanScharfesS(GetRegion().GetMyTemplate().DisplayName) LostTowers doesn't have a region
