class XComGameState_Effect_DLC_3AbsorptionField extends XComGameState_Effect
	config(GameData_SoldierSkills);

var int EnergyAbsorbed;         //  tracks energy absorbed, to be used as damage on the next primary weapon attack
