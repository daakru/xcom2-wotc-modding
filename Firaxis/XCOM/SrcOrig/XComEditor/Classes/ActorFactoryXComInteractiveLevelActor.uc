class ActorFactoryXComInteractiveLevelActor extends ActorFactory
	config(Editor)
	native;
...
defaultproperties
{
	MenuName="Add XComInteractiveLevelActor";
	NewActorClass=class'XComGame.XComInteractiveLevelActor';
}