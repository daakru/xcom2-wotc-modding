...
/** True is the user wants emitter to be allowed to spawn lights. (Always true in game. In editor, this causes levels to appear to need to be saved, when they actually don't need to) */
var(Options) config bool bAllowEmitterLightSpawning;
...
var(Options) config bool bDefaultColorPicker_sRGB;