...
/** If TRUE, clicking an actor in a group will select the group instead of all the member actors. */
var bool bGroupSelecting; // FIRAXIS
...
var transient byte EdEnvLightSetting;

/** If true, then materials with the "UseRainToD?" static switch parameter will be set to true */
var transient bool bShowWet;
