...
// FIRAXIS begin
var(Options)	config string		BackgroundMesh;
var(Options)	config vector		BackgroundPosition;
var(Options)	config rotator		BackgroundRotation;
var(Options)	config float		BackgroundScale;
var(Options)	config vector		BackgroundScale3D;
// FIRAXIS end
