...
/** Enabling this option will read in the normals only from teh FBX file. */
var(SkeletalMesh) config bool bImportNormalsOnly<DisplayName=Import Normals>;
...
var(SkeletalMesh,Advanced) bool bSplitNonMatchingTriangles<DisplayName=Preserve Smoothing Groups>;
