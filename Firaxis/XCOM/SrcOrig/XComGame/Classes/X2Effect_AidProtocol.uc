...
static function EventListenerReturn OnItemRecalled(Object EventData, Object EventSource, XComGameState GameState, Name Event, Object CallbackData)
{
	...
	NewRecalledItem = XComGameState_Item(NewGameState.ModifyStateObject(class'XComGameState_Item', RecalledItem.ObjectID));
