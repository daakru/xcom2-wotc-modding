...
simulated function StartUpgradeFacility()
{
	...
	FacilityState.ActivateUpgrade(NewGameState, UpgradeTemplate.DataName);
...
simulated function ReassignUpgradeEngineerCallback(Name eAction)
{
...
simulated function ReassignUpgradeEngineer()
{
	...
	Room.GetBuildSlot().AssignStaffToSlot(UnitInfo);
...
simulated public function CancelUpgradeDialogueCallback(Name eAction, UICallbackData xUserData)
{
	local XComGameState_HeadquartersXCom XComHQ;
