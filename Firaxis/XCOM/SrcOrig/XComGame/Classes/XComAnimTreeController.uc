...
// this enum should be kept in sync with XComNarrativeMoment.EngineBlendMaskIndex
enum BlendMaskIndex
{
	BLEND_MASK_FULLBODY,
	BLEND_MASK_UPPERBODY,
	BLEND_MASK_LEFTARM,
	BLEND_MASK_RIGHTARM,
	BLEND_MASK_HEAD,
	BLEND_MASK_ADDITIVE,
...
var private XComAnimNodeBlendDynamic        LeftArmDynamicNode;
var private XComAnimNodeBlendDynamic        RightArmDynamicNode;
var private XComAnimNodeBlendDynamic        HeadDynamicNode;
...
// DynamicNode
native function AnimNodeSequence PlayDynamicAnim(out CustomAnimParams Params, BlendMaskIndex Mask);
...
native function AnimNodeSequence PlayLeftArmDynamicAnim(out CustomAnimParams Params);
native function AnimNodeSequence PlayRightArmDynamicAnim(out CustomAnimParams Params);
native function AnimNodeSequence PlayHeadDynamicAnim(out CustomAnimParams Params);
...
native function BlendOutDynamicNode(float BlendTime, BlendMaskIndex Mask);
native function BlendOutAdditiveDynamicNode(float BlendTime);
native function BlendOutUpperBodyDynamicNode(float BlendTime);
native function BlendOutLeftArmDynamicNode(float BlendTime);
native function BlendOutRightArmDynamicNode(float BlendTime);
native function BlendOutHeadDynamicNode(float BlendTime);
...
native function bool ShouldPlayAlternativeRunStop();
native function AnimNodeSequence DeathOnLoad(bool WillRagdoll, const out CustomAnimParams Params);
native function BoneAtom GetStartingAtomFromDesiredEndingAtom(out CustomAnimParams Params);
