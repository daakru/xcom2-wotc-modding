...
simulated function BuildScreen()
{
	...
	// Some missions cannot be canceled once the squad is confirmed
	if (!class'XComGameState_HeadquartersXCom'.static.IsObjectiveCompleted('T0_M7_WelcomeToGeoscape') || GetMission().GetMissionSource().bCannotBackOutSquadSelect)
	{
		Button2.Hide();
	}
