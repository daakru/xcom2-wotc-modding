...
simulated function string GetStateDebugString()
{
	...
	DebugString $= "    PauseReplayRequested:" @ PauseReplayRequested;
	DebugString $= "    VisualizerBusy:" @ class'XComGameStateVisualizationMgr'.static.VisualizerBusy();
	DebugString $= "    VisualizerStateName:" @ `XCOMVISUALIZATIONMGR.GetStateName();
	DebugString $= "\n\n";
	return DebugString;
}
