...
simulated function BuildAssignedStaffTooltip(XComGameState_HeadquartersRoom Room, int SlotIndex)
{
	...
	if( Staffer != none )
	{
		...
		UnitInfo.PairUnitRef = StaffSlotState.GetPairedStaffRef();
