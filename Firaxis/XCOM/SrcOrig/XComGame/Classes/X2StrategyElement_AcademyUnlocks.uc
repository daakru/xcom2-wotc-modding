...
static function array<X2DataTemplate> CreateTemplates()
{
	...
	Templates.AddItem(MeditationPreparationUnlock());
	Templates.AddItem(ParkourUnlock());
	Templates.AddItem(InfiltrationUnlock());
...
static function X2SoldierAbilityUnlockTemplate HuntersInstinctUnlock()
{
	...
	Template.AllowedClasses.AddItem('CentralOfficer');
...
static function X2SoldierAbilityUnlockTemplate CoolUnderPressureUnlock()
{
	...
	Template.AllowedClasses.AddItem('ChiefEngineer');
...
static function X2SoldierUnlockTemplate MeditationPreparationUnlock()
{
	local X2SoldierAbilityUnlockTemplate Template;
	local ArtifactCost Resources;
...
static function X2SoldierUnlockTemplate InfiltrationUnlock()
{
	local X2SoldierAbilityUnlockTemplate Template;
	local ArtifactCost Resources;
