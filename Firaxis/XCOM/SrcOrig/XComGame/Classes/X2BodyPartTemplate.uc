...
// Armor
var bool bVeteran;
var bool bAnyArmor; // This body part can be associated with all armor types for a specific character
...
// Required soldier class for this body part to be available
var name ReqClass;
...
// Jwats: True if this template represents a templar's ghost pawn
var () bool bGhostPawn;
