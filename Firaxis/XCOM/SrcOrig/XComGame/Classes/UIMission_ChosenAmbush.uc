...
//---------------------------------------------------------------------------------------
class UIMission_ChosenAmbush extends UIMission;
...
{
	local XComGameState_MissionSiteChosenAmbush AmbushSite;
	
	CloseScreen();

	AmbushSite = XComGameState_MissionSiteChosenAmbush(GetMission());
...
simulated function XComGameState_MissionSite GetMission()
{
	...
	History = `XCOMHISTORY;
	return XComGameState_MissionSiteChosenAmbush(History.GetGameStateForObjectID(MissionRef.ObjectID));
}
