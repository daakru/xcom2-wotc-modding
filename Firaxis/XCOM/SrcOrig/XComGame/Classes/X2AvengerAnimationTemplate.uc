...
{
	if((UnitState.IsSoldier() && AnimCharacter.CharacterType == eStaff_Soldier) ||
		(UnitState.IsScientist() && (AnimCharacter.CharacterType == eStaff_Scientist || AnimCharacter.CharacterType == eStaff_HeadScientist)) ||
		(UnitState.IsEngineer() && (AnimCharacter.CharacterType == eStaff_Engineer || AnimCharacter.CharacterType == eStaff_HeadEngineer)))
	{
