...
simulated function InitScreen(XComPlayerController InitController, UIMovie InitMovie, optional name InitName)
{
	...
	//bsg-jneal (3.20.17): super input was incorrectly blocking controller input when returning to this screen
	if(`ISCONTROLLERACTIVE)
	{
		bIgnoreSuperInput = true;
	}
	//bsg-jneal (3.20.17): end
}
...
simulated function RealizeNavHelp()
{
	...
	NavHelp.AddSelectNavHelp(); // bsg-jrebar (4.6.17) Reordering nav help
