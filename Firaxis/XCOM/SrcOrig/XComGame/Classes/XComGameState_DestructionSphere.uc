...
function SetDamageSphereVisible(bool Visible)
{
	...
	NewSphereState = XComGameState_DestructionSphere(NewGameState.ModifyStateObject(class'XComGameState_DestructionSphere', ObjectID));
...
function EventListenerReturn OnSyncVisualizer(Object EventData, Object EventSource, XComGameState GameState, Name Event, Object CallbackData)
{
...
static function XComGameState_DestructionSphere GetStateObject(XComDestructionSphere SphereActor)
{
	...
	ObjectState = XComGameState_DestructionSphere(NewGameState.CreateNewStateObject(class'XComGameState_DestructionSphere'));
	History.SetVisualizer(ObjectState.ObjectID, SphereActor);
