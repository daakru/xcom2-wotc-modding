...
// name used to identify this camera
var name CameraTag;

// Contains the BuildingVis Focus Points generated this frame.
var array<TFocusPoints> VisFocusPoints;
...
/// <summary>
/// Updates the Building Vis Focus points for the frame.
/// </summary>
function UpdateCameraFocusPoints()
{
	VisFocusPoints.Length = 0;

	AddCameraFocusPoints();
}

/// <summary>
/// Adds the desired focus points to the VisFocusPoints array. Camears should override this for desired functionality
/// </summary>
...
/// <summary>
/// Override this function to return true if your camera behavior wants to include a dither 
/// effect on all obejcts between the camera and designated target
/// </summary>
