...
static function name GetDepthBasedLootTableName(XComGameState_HeadquartersRoom RoomState)
{
	...
	return SpecialRoomFeature.LootCarrierNames[`STRATEGYDIFFICULTYSETTING].Names[RowNum - RowOffset]; // The index gives the loot table for the level which the feature is placed at
}
