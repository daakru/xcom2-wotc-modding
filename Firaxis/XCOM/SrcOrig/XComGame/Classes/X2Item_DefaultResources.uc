...
static function array<X2DataTemplate> CreateTemplates()
{
	...
	// Ability Points
	Resources.AddItem(CreateAbilityPointCache());
...
static function X2DataTemplate CreateIntel()
{
	...
	Template.strInventoryImage = "img:///UILibrary_XPACK_StrategyImages.Invx_Intel";
	Template.ItemCat = 'resource';
...
static function X2DataTemplate CreateAlienAlloy()
{
	...
	Template.strInventoryImage = "img:///UILibrary_XPACK_StrategyImages.Invx_Alien_Alloy";
	Template.ItemCat = 'resource';
	Template.TradingPostValue = 3;
...
static function X2DataTemplate CreateEleriumDust()
{
	...
	Template.strInventoryImage = "img:///UILibrary_XPACK_StrategyImages.Invx_Elerium_Crystals";
	Template.ItemCat = 'resource';
...
static function X2DataTemplate CreateAbilityPointCache()
{
	local X2ItemTemplate Template;

	`CREATE_X2TEMPLATE(class'X2ItemTemplate', Template, 'AbilityPointCache');
	...
	Template.ResourceTemplateName = 'AbilityPoint';
	Template.ResourceQuantity = 9;
