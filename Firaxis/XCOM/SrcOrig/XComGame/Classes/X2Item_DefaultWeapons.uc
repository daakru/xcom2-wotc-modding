...
var config WeaponDamageValue ADVCOUNTEROPM1_WPN_BASEDAMAGE;
var config WeaponDamageValue ADVCOUNTEROPM2_WPN_BASEDAMAGE;
var config WeaponDamageValue ADVCOUNTEROPM3_WPN_BASEDAMAGE;
...
var config WeaponDamageValue DEATH_EXPLOSION_BASEDAMAGE;

// ***** Data for retaliation militia *****
var config WeaponDamageValue MILITIARIFLE_CONVENTIONAL_BASEDAMAGE;
var config WeaponDamageValue MILITIARIFLE_MAGNETIC_BASEDAMAGE;
var config WeaponDamageValue MILITIARIFLE_BEAM_BASEDAMAGE;
...
var config int ADVCOUNTEROPM1_IDEALRANGE;
var config int ADVCOUNTEROPM2_IDEALRANGE;
var config int ADVCOUNTEROPM3_IDEALRANGE;
...
static function array<X2DataTemplate> CreateTemplates()
{
	...
	Weapons.AddItem(CreateTemplate_MilitiaRifle_Conventional());
	Weapons.AddItem(CreateTemplate_MilitiaRifle_Magnetic());
	Weapons.AddItem(CreateTemplate_MilitiaRifle_Beam());
	...
	Weapons.AddItem(CreateTemplate_AdvCounterOpM1_WPN());
	Weapons.AddItem(CreateTemplate_AdvCounterOpM2_WPN());
	Weapons.AddItem(CreateTemplate_AdvCounterOpM3_WPN());
...
static function X2DataTemplate CreateTemplate_MilitiaRifle_Conventional()
{
	local X2WeaponTemplate Template;

	`CREATE_X2TEMPLATE(class'X2WeaponTemplate', Template, 'MilitiaRifle_CV');
	Template.WeaponPanelImage = "_ConventionalRifle";                       // used by the UI. Probably determines iconview of the weapon.
	Template.EquipSound = "Conventional_Weapon_Equip";
	...
	Template.WeaponCat = 'rifle';
	Template.WeaponTech = 'conventional';
	//BEGIN AUTOGENERATED CODE: Template Overrides 'MilitiaRifle_CV'
	Template.strImage = "img:///UILibrary_Common.ConvAssaultRifle.ConvAssault_Base";
	//END AUTOGENERATED CODE: Template Overrides 'MilitiaRifle_CV'
	Template.Tier = 0;

	Template.RangeAccuracy = default.FLAT_CONVENTIONAL_RANGE;
	Template.BaseDamage = default.MILITIARIFLE_CONVENTIONAL_BASEDAMAGE;
	Template.Aim = default.ASSAULTRIFLE_CONVENTIONAL_AIM;
	Template.CritChance = default.ASSAULTRIFLE_CONVENTIONAL_CRITCHANCE;
	Template.iClipSize = default.ASSAULTRIFLE_CONVENTIONAL_ICLIPSIZE;
	Template.iSoundRange = default.ASSAULTRIFLE_CONVENTIONAL_ISOUNDRANGE;
...
static function X2DataTemplate CreateTemplate_MilitiaRifle_Magnetic()
{
	local X2WeaponTemplate Template;

	`CREATE_X2TEMPLATE(class'X2WeaponTemplate', Template, 'MilitiaRifle_MG');
	Template.WeaponPanelImage = "_ConventionalRifle";                       // used by the UI. Probably determines iconview of the weapon.
	Template.EquipSound = "Conventional_Weapon_Equip";
	...
	Template.BaseDamage = default.MILITIARIFLE_MAGNETIC_BASEDAMAGE;
	Template.Aim = default.ASSAULTRIFLE_MAGNETIC_AIM;
	Template.CritChance = default.ASSAULTRIFLE_MAGNETIC_CRITCHANCE;
	Template.iClipSize = default.ASSAULTRIFLE_MAGNETIC_ICLIPSIZE;
	Template.iSoundRange = default.ASSAULTRIFLE_CONVENTIONAL_ISOUNDRANGE;
...
static function X2DataTemplate CreateTemplate_MilitiaRifle_Beam()
{
	local X2WeaponTemplate Template;

	`CREATE_X2TEMPLATE(class'X2WeaponTemplate', Template, 'MilitiaRifle_BM');
	Template.WeaponPanelImage = "_ConventionalRifle";                       // used by the UI. Probably determines iconview of the weapon.
	Template.EquipSound = "Conventional_Weapon_Equip";
	...
	Template.BaseDamage = default.MILITIARIFLE_BEAM_BASEDAMAGE;
	Template.Aim = default.ASSAULTRIFLE_BEAM_AIM;
	Template.CritChance = default.ASSAULTRIFLE_BEAM_CRITCHANCE;
	Template.iClipSize = default.ASSAULTRIFLE_BEAM_ICLIPSIZE;
	Template.iSoundRange = default.ASSAULTRIFLE_CONVENTIONAL_ISOUNDRANGE;
...
static function X2DataTemplate CreateTemplate_AdvCounterOpM1_WPN()
{
	local X2WeaponTemplate Template;

	`CREATE_X2TEMPLATE(class'X2WeaponTemplate', Template, 'AdvCounterOpM1_WPN');
	Template.WeaponPanelImage = "_ConventionalRifle";                       // used by the UI. Probably determines iconview of the weapon.
	Template.ItemCat = 'weapon';
	Template.WeaponCat = 'sniper_rifle';
	Template.WeaponTech = 'magnetic';
	...
	Template.RangeAccuracy = default.LONG_MAGNETIC_RANGE;
	Template.BaseDamage = default.ADVCOUNTEROPM1_WPN_BASEDAMAGE;
	Template.iClipSize = default.SNIPERRIFLE_MAGNETIC_ICLIPSIZE;
	Template.iSoundRange = default.SNIPERRIFLE_MAGNETIC_ISOUNDRANGE;
	Template.iEnvironmentDamage = default.SNIPERRIFLE_MAGNETIC_IENVIRONMENTDAMAGE;
	Template.iIdealRange = default.ADVCOUNTEROPM1_IDEALRANGE;
	...
	// This all the resources; sounds, animations, models, physics, the works.
	Template.GameArchetype = "CovertEscape_TempAssets.WP_SniperRifle_AdventCounterOp";
...
static function X2DataTemplate CreateTemplate_AdvCounterOpM2_WPN()
{
	local X2WeaponTemplate Template;

	`CREATE_X2TEMPLATE(class'X2WeaponTemplate', Template, 'AdvCounterOpM2_WPN');
	Template.WeaponPanelImage = "_ConventionalRifle";                       // used by the UI. Probably determines iconview of the weapon.
	Template.ItemCat = 'weapon';
	Template.WeaponCat = 'sniper_rifle';
	Template.WeaponTech = 'magnetic';
	...
	Template.RangeAccuracy = default.LONG_MAGNETIC_RANGE;
	Template.BaseDamage = default.ADVCOUNTEROPM2_WPN_BASEDAMAGE;
	Template.iClipSize = default.SNIPERRIFLE_MAGNETIC_ICLIPSIZE;
	Template.iSoundRange = default.SNIPERRIFLE_MAGNETIC_ISOUNDRANGE;
	Template.iEnvironmentDamage = default.SNIPERRIFLE_MAGNETIC_IENVIRONMENTDAMAGE;
	Template.iIdealRange = default.ADVCOUNTEROPM2_IDEALRANGE;
...
static function X2DataTemplate CreateTemplate_AdvCounterOpM3_WPN()
{
	local X2WeaponTemplate Template;

	`CREATE_X2TEMPLATE(class'X2WeaponTemplate', Template, 'AdvCounterOpM3_WPN');
	Template.WeaponPanelImage = "_ConventionalRifle";                       // used by the UI. Probably determines iconview of the weapon.
	Template.ItemCat = 'weapon';
	Template.WeaponCat = 'sniper_rifle';
	Template.WeaponTech = 'magnetic';
	...
	Template.RangeAccuracy = default.LONG_MAGNETIC_RANGE;
	Template.BaseDamage = default.ADVCOUNTEROPM3_WPN_BASEDAMAGE;
	Template.iClipSize = default.SNIPERRIFLE_MAGNETIC_ICLIPSIZE;
	Template.iSoundRange = default.SNIPERRIFLE_MAGNETIC_ISOUNDRANGE;
	Template.iEnvironmentDamage = default.SNIPERRIFLE_MAGNETIC_IENVIRONMENTDAMAGE;
	Template.iIdealRange = default.ADVCOUNTEROPM3_IDEALRANGE;
