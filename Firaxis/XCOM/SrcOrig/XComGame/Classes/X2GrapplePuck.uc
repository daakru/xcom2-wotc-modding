...
struct native DistanceModByAbility
{
	var name AbilityName;
	var float DistanceModMeters;
};
...
var private const config array<DistanceModByAbility> GrappleDistanceModsByAbility;
...
native function float GetMaxGrappleDistance(XComGameState_Unit Unit) const;
