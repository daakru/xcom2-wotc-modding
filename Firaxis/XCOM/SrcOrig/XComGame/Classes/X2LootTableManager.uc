...
native function RollForLootCarrier(const out LootCarrier Carrier, out LootResults Results, optional XComGameState StateObjectCache);
native function RollForGlobalLootCarrier(int Index, out LootResults Results, optional XComGameState StateObjectCache);
