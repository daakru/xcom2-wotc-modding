...
{	
	...
	{
		`warn("SeqAct_SetDestructibleActorState called on non destructible actor:"@TargetActor@" This sequence action requires a destructible actor or interactive object input.");
	}
}
