...
static function array<X2DataTemplate> CreateTemplates()
{
	...
	Templates.AddItem(CreateAbandonedCityTemplate());
	Templates.AddItem(CreateTunnelsTemplate());
	Templates.AddItem(CreateStrongholdTemplate());
...
static function X2DataTemplate CreateAbandonedCityTemplate()
{
	local X2MissionSiteDescriptionTemplate Template;

	`CREATE_X2TEMPLATE(class'X2MissionSiteDescriptionTemplate', Template, 'AbandonedCity');

	Template.GetMissionSiteDescriptionFn = GetAbandonedCityMissionSiteDescription;

	return Template;
}

static function X2DataTemplate CreateTunnelsTemplate()
{
	local X2MissionSiteDescriptionTemplate Template;

	`CREATE_X2TEMPLATE(class'X2MissionSiteDescriptionTemplate', Template, 'Tunnels');

	Template.GetMissionSiteDescriptionFn = GetTunnelsMissionSiteDescription;

	return Template;
}

static function X2DataTemplate CreateStrongholdTemplate()
{
	local X2MissionSiteDescriptionTemplate Template;

	`CREATE_X2TEMPLATE(class'X2MissionSiteDescriptionTemplate', Template, 'Stronghold');

	Template.GetMissionSiteDescriptionFn = GetStrongholdMissionSiteDescription;
...
static function string GetAbandonedCityMissionSiteDescription(string BaseString, XComGameState_MissionSite MissionSite)
{
	local string OutputString;
	local X2CityTemplate NearestCityTemplate;
	...
	OutputString = Repl(OutputString, "<AbandonedCity>", NearestCityTemplate.DisplayName);

	return OutputString;
}
static function string GetTunnelsMissionSiteDescription(string BaseString, XComGameState_MissionSite MissionSite)
{
	local string OutputString;
	local X2CityTemplate NearestCityTemplate;
...
static function string GetStrongholdMissionSiteDescription(string BaseString, XComGameState_MissionSite MissionSite)
{
	local string OutputString;
