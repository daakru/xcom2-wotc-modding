//---------------------------------------------------------------------------------------
//  FILE:    X2BreakthroughCondition_WeaponType.uc
//  AUTHOR:  Russell Aasland
//           
//---------------------------------------------------------------------------------------
//  Copyright (c) 2016 Firaxis Games, Inc. All rights reserved.
//---------------------------------------------------------------------------------------
class X2BreakthroughCondition_WeaponType extends X2BreakthroughCondition 
	editinlinenew
	hidecategories(Object);

var name WeaponTypeMatch;
...
function bool MeetsCondition(XComGameState_BaseObject kTarget)
{
	...
	return WeaponTemplate.WeaponCat == WeaponTypeMatch;
}