...
event Activated()
{
	...
	if( bCreate )
	{
		...
		{
			XComPresentationLayer(kTacticalController.Pres).QueueStandardMessage(class'UIUtilities_Input'.static.InsertGamepadIconsMessenger(Message), eIcon_ExclamationMark, ,-1.0, ID);
