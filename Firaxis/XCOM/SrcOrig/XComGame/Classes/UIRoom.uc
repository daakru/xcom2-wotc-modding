...
var localized string m_strInstantExcavation;
...
simulated function UpdateData()
{
	...
	if (GetRoom().HasStaff() || XComHQ.bInstantSingleExcavation)
	{
...
simulated function String GetExcavationStatusString()
{
	...
	else if (Room.HasStaff() || XComHQ.bInstantSingleExcavation)
	{
...
simulated function String GetExcavationTimeEstimateString()
{
	...
	else if (XComHQ.bInstantSingleExcavation)
	{
		return m_strInstantExcavation;
	}
...
simulated function CloseScreen()
{
	...
	else
	{
		...
		SetTimer(0.01, false, nameof(UIRoom_FinishTransitionExit));
	}
}
...
simulated function ClearRoomCB(Name eAction)
{
	local XComGameState NewGameState;
...
simulated function bool OnUnrealCommand(int cmd, int arg)
{
	...
	case class'UIUtilities_Input'.const.FXS_BUTTON_X:
		...
		break;
	//bsg-crobinson (5.17.17): Block up/down input from changing staff slots
	...
	case class'UIUtilities_Input'.const.FXS_DPAD_LEFT: //bsg-crobinson (5.17.17): Add dpad/stick input
	case class'UIUtilities_Input'.const.FXS_VIRTUAL_LSTICK_LEFT:
		m_kStaffSlotContainer.Navigator.Prev();
		break;
	case class'UIUtilities_Input'.const.FXS_DPAD_RIGHT: //bsg-crobinson (5.17.17): Add dpad/stick input
	case class'UIUtilities_Input'.const.FXS_VIRTUAL_LSTICK_RIGHT:
		m_kStaffSlotContainer.Navigator.Next();
		break;
	default:
		bHandled = false;
		break;
