...
function AddVisualizationActionMetadatas(XComGameState GameState)
{
	...
	{
		ActionMetadata.StateObject_OldState = WorldEffectData;
		ActionMetadata.StateObject_NewState = WorldEffectData;
		WorldEffect.AddX2ActionsForVisualization(GameState, ActionMetadata, '');
