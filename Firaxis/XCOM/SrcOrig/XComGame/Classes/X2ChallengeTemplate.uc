...
var array<name> ExcludeSelectorNames; // previous selector names that exclude this template
var array<name> PreferSelectorNames; // previous selector names that prefer this template
