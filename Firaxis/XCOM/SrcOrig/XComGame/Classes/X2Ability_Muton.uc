...
function CounterAttack_MergeVisualization(X2Action BuildTree, out X2Action VisualizationTree)
{
...
//BEGIN AUTOGENERATED CODE: Template Overrides 'DelayedExecute'
	Template.bFrameEvenWhenUnitIsHidden = true;
//END AUTOGENERATED CODE: Template Overrides 'DelayedExecute'
...
//BEGIN AUTOGENERATED CODE: Template Overrides 'Execute'
	Template.bFrameEvenWhenUnitIsHidden = true;
//END AUTOGENERATED CODE: Template Overrides 'Execute'

	return Template;
}

simulated function DelayedExecute_BuildVisualization(XComGameState VisualizeGameState)
{
...
//BEGIN AUTOGENERATED CODE: Template Overrides 'Counterattack'
	Template.bFrameEvenWhenUnitIsHidden = true;
//END AUTOGENERATED CODE: Template Overrides 'Counterattack'
