...
function XComGameState_Unit AddRandomSoldierToLoadout(out XComGameState kLoadoutState)
{
	...
	NewSoldierState.bIgnoreWillSystem = true; // All MP units should not use the Will system
...
function XComGameState_Unit CreateMPUnitState(X2MPCharacterTemplate MPCharacterTemplate, out XComGameState kLoadoutState)
{
	...
	{
		NewUnitState.ResetSoldierRank(); // Reset rank to erase any abilities and stat changes created by the default single-player class
		...
		NewUnitState.bIgnoreWillSystem = true; // All MP units should not use the Will system
...
static function UpdateUnit(XComGameState_Unit FromUnit, XComGameState_Unit NewUnit, XComGameState NewGameState)
{
	...
	if (NewUnit.IsSoldier())
	{
		...
		NewUnit.bIgnoreWillSystem = true; // All MP units should not use the Will system
