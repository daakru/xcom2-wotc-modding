...
simulated function ChangeForm_BuildVisualization(XComGameState VisualizeGameState)
{
...
static function X2AbilityTemplate CreateChangeFormSawEnemyAbility()
{
	...
	Template.BuildNewGameStateFn = TypicalAbility_BuildGameState;
//BEGIN AUTOGENERATED CODE: Template Overrides 'ChangeFormSawEnemy'
	Template.bFrameEvenWhenUnitIsHidden = true;
//END AUTOGENERATED CODE: Template Overrides 'ChangeFormSawEnemy'
...
static function X2AbilityTemplate CreateScythingClawsMPAbility()
{
	...
	Template.BuildVisualizationFn = TypicalAbility_BuildVisualization;
	Template.CinescriptCameraType = "Faceless_ScythingClaws";
//BEGIN AUTOGENERATED CODE: Template Overrides 'ScythingClawsMP'
	Template.bFrameEvenWhenUnitIsHidden = true;
//END AUTOGENERATED CODE: Template Overrides 'ScythingClawsMP'
