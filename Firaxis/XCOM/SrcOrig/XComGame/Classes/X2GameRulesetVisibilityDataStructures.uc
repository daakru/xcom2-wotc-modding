...
{	
	...
	var bool					bVisibleDefaultToDefault;// TRUE if the LOS trace between the source and dest default tiles is clear
	...
	DefaultTargetDist(FLT_MAX)
    {
		...
		bVisibleDefaultToDefault = FALSE;
	...
	FORCEINLINE UBOOL operator==(const FGameRulesCache_VisibilityInfo &Other) const
	{
		return  SourceID == Other.SourceID &&
			...
			bVisibleDefaultToDefault == Other.bVisibleDefaultToDefault &&
