...
delegate ActionCallbackEx( Name eAction, UICallbackData xUserData );
...
simulated function OnInit()
{
	...
	{
		SetTimer(4.0, false, nameof(OnAccept));
	}
}
...
simulated function Realize()
{
	...
	Invoke("realize"); // bsg-jrebar (4/24/17): Realize changes at the end to update before we present
}
