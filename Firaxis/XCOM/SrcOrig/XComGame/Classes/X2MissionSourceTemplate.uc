...
var bool						bCannotBackOutUI; // Once the mission is displayed, it cannot be ignored or canceled
var bool						bCannotBackOutSquadSelect; // Once the mission squad is selected, the mission cannot be canceled
var bool						bBlocksNegativeTraits; // Negative traits will not be gained after this mission if true
var bool						bBlockFirstEncounterVO;
var bool						bBlockSitrepDisplay; // Don't show SITREPs in strategy or tactical, even if they exist
var bool						bBlockShaken; // Soldiers can't reach the Shaken mental state after the mission
...
var Delegate<GetSitrepsDelegate> GetSitrepsFn; // Determine what sitreps should be active for this mission
...
var Delegate<GetMissionRegionDelegate> GetMissionRegionFn;
...
delegate MissionPopupDelegate(optional XComGameState_MissionSite MissionState);
delegate array<XComGameState_WorldRegion> GetMissionRegionDelegate(XComGameState NewGameState);
...
delegate array<name> GetSitrepsDelegate(XComGameState_MissionSite MissionState);
