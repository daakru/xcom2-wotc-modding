...
static private native function SwapDeco(string TargetBiomeType, string TargetPlotType, string TargetMissionType);
...
// look decent
static function AdjustParcelsForBiomeType(string TargetBiomeType, string TargetPlotType, string TargetMissionType)
{
	...
	if(TargetPlotType != "")
	{
		...
		SwapDeco(TargetBiomeType, TargetPlotType, TargetMissionType);
