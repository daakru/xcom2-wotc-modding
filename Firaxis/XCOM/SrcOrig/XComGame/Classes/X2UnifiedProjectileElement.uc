...
var(ProjectileTravelSettings)		bool bTriggerPawnHitEffects<ToolTip="If set to TRUE, this flag indicates that this projectile should cause the target pawn to play hit and meta hit effects.">;
...
var(ProjectileSoundEffectSettings)	AkEvent FireSoundLoopStop<ToolTip="If set, will play on the object that shot the projectile when the projectile dies">;
