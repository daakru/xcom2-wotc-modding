...
simulated function AbortMission_BuildVisualization(XComGameState VisualizeGameState)
{
	local XComGameStateHistory History;
...
simulated function PlaceEvacZone_BuildVisualization(XComGameState VisualizeGameState)
{
	...
	Metadata.StateObject_NewState = EvacState;
	Metadata.StateObject_OldState = EvacState;
	Metadata.VisualizeActor = EvacState.GetVisualizer();
	class'X2Action_PlaceEvacZone'.static.AddToVisualizationTree(Metadata, VisualizeGameState.GetContext());
}
...
simulated function LiftOffAvenger_BuildVisualization(XComGameState VisualizeGameState)
{
}
