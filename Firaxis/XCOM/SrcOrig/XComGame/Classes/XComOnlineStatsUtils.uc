...
defaultproperties
{
	...
	StatsViewPropertyToColumnIdMap(5)=(ViewId=STATS_VIEW_EW_DEATHMATCHALLTIMERANKED, PropertyId=PROPERTY_MP_DEATHMATCH_RANKED_MATCHES_WON, ColumnId=STATS_COLUMN_EW_DEATHMATCHALLTIMERANKED_MATCHES_WON);
	StatsViewPropertyToColumnIdMap(6)=(ViewId=STATS_VIEW_EW_DEATHMATCHALLTIMERANKED, PropertyId=PROPERTY_MP_DEATHMATCH_RANKED_MATCHES_LOST, ColumnId=STATS_COLUMN_EW_DEATHMATCHALLTIMERANKED_MATCHES_LOST);
	StatsViewPropertyToColumnIdMap(7)=(ViewId=STATS_VIEW_EW_DEATHMATCHALLTIMERANKED, PropertyId=PROPERTY_MP_DEATHMATCH_RANKED_DISCONNECTS, ColumnId=STATS_COLUMN_EW_DEATHMATCHALLTIMERANKED_MATCHES_DISCONNECTED);
	StatsViewPropertyToColumnIdMap(8)=(ViewId=STATS_VIEW_EW_DEATHMATCHALLTIMERANKED, PropertyId=PROPERTY_MP_DEATHMATCH_RANKED_MATCH_STARTED, ColumnId=STATS_COLUMN_EW_DEATHMATCHALLTIMERANKED_MATCH_STARTED);
