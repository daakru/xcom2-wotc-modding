...
var localized string m_strAmpersand; // used to translate and say "soldier1 & soldier2"
var localized string m_strOpenQuote; // used to translate nickname quotes
var localized string m_strCloseQuote;// used to translate nickname quotes

var localized string m_strJapaneseDoubleByteComma; 
...
static function string FormatCommaSeparatedNouns(string TargetString)
{
	if( GetLanguage() == "JPN" ) // TTP 10876: no commas in Japanese between two coordinate nouns. 
	{
		TargetString = Repl(TargetString, ",", class'UIUtilities_Text'.default.m_strJapaneseDoubleByteComma);
	}
	return TargetString;
}