...
function Init()
{
	...
	WorldNarrativeActor = X2WorldNarrativeActor(Metadata.StateObject_NewState.GetVisualizer());

	WorldNarrativeActorState = XComGameState_WorldNarrativeActor(Metadata.StateObject_NewState);
