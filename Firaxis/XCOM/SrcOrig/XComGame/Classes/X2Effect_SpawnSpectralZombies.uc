class X2Effect_SpawnSpectralZombies extends X2Effect_SpawnUnit;
...
function vector GetSpawnLocation(const out EffectAppliedData ApplyEffectParameters, XComGameState NewGameState)
{
	...
	TargetLocation = SpawnManager.GetCurrentXComLocation();

	SpawnLocation = SpawnManager.SelectReinforcementsLocation(none, TargetLocation, 4, false, false, false, true);
...
function OnSpawnComplete(const out EffectAppliedData ApplyEffectParameters, StateObjectReference NewUnitRef, XComGameState NewGameState, XComGameState_Effect NewEffectState)
{
	...
	NewEffectParams.EffectRef.SourceTemplateName = class'X2Ability_ChosenWarlock'.default.SpectralZombieLinkName;
