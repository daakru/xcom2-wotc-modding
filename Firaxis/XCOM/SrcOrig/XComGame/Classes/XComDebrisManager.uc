...
var config int MaxNumDebrisSpawnsPerFrame;	// bsg-mfawcett(07.11.16): Clamp maximum number of effects allowed to spawn per frame to alleviate performance issues with Dimensional Rift on console
