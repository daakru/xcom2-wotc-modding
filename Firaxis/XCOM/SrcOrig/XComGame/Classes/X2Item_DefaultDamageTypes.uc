...
static function array<X2DataTemplate> CreateTemplates()
{
	...
	DamageTypes.AddItem(CreateFallingDamageType());
	DamageTypes.AddItem(CreateBleedingDamageType());
...
static function X2DamageTypeTemplate CreateFallingDamageType()
{
	local X2DamageTypeTemplate Template;

	`CREATE_X2TEMPLATE(class'X2DamageTypeTemplate', Template, 'Falling');
...
static function X2DamageTypeTemplate CreateBleedingDamageType()
{
	local X2DamageTypeTemplate Template;

	`CREATE_X2TEMPLATE(class'X2DamageTypeTemplate', Template, 'Bleeding');
