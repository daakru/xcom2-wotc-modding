...
static function bool IsSuppliesRewardNeeded(XComGameState_PointOfInterest POIState)
{
	...
	if (XComHQ.GetSupplies() <= `ScaleStrategyArrayInt(POITemplate.IsNeededAmount))
	{
		return true;
	}
...
static function bool IsIntelRewardNeeded(XComGameState_PointOfInterest POIState)
{
	local XComGameState_HeadquartersXCom XComHQ;
...
static function bool IsAlloysRewardNeeded(XComGameState_PointOfInterest POIState)
{
	local XComGameState_HeadquartersXCom XComHQ;
	local X2PointOfInterestTemplate POITemplate;
	...
	if (XComHQ.GetAlienAlloys() <= `ScaleStrategyArrayInt(POITemplate.IsNeededAmount))
	{
		return true;
	}
...
static function bool IsEleriumRewardNeeded(XComGameState_PointOfInterest POIState)
{
	local XComGameState_HeadquartersXCom XComHQ;
	local X2PointOfInterestTemplate POITemplate;
	...
	if (XComHQ.GetEleriumDust() <= `ScaleStrategyArrayInt(POITemplate.IsNeededAmount))
	{
		return true;
	}
...
static function bool IsScientistRewardNeeded(XComGameState_PointOfInterest POIState)
{
	local XComGameState_HeadquartersXCom XComHQ;
...
static function bool CanScientistPOIAppear(XComGameState_PointOfInterest POIState)
{
	local XComGameState_HeadquartersXCom XComHQ;
...
static function bool IsEngineerRewardNeeded(XComGameState_PointOfInterest POIState)
{
	local XComGameState_HeadquartersXCom XComHQ;
	local TDateTime StartDateTime, CurrentTime;
...
static function bool CanEngineerPOIAppear(XComGameState_PointOfInterest POIState)
{
	local XComGameState_HeadquartersXCom XComHQ;
	local XComGameState_HeadquartersResistance ResHQ;
...
static function bool IsRookiesRewardNeeded(XComGameState_PointOfInterest POIState)
{
	local XComGameState_HeadquartersXCom XComHQ;
	local X2PointOfInterestTemplate POITemplate;
	...
	if (XComHQ.GetNumberOfDeployableSoldiers() < `ScaleStrategyArrayInt(POITemplate.IsNeededAmount))
	{
		return true;
	}
...
static function bool IsPowerRewardNeeded(XComGameState_PointOfInterest POIState)
{
	local XComGameState_HeadquartersXCom XComHQ;
	local X2PointOfInterestTemplate POITemplate;
	...
	if (PowerDifferential <= `ScaleStrategyArrayInt(POITemplate.IsNeededAmount))
	{
		return true;
	}
...
static function bool IsResCommsRewardNeeded(XComGameState_PointOfInterest POIState)
{
	local XComGameState_HeadquartersXCom XComHQ;
	local X2PointOfInterestTemplate POITemplate;
	...
	if (XComHQ.GetRemainingContactCapacity() <= `ScaleStrategyArrayInt(POITemplate.IsNeededAmount))
	{
		return true;
	}
...
static function bool CanResCommsAppear(XComGameState_PointOfInterest POIState)
{
...
static function bool CanGOpsAppear(XComGameState_PointOfInterest POIState)
{
...
static function bool CanHeavyWeaponPOIAppear(XComGameState_PointOfInterest POIState)
{
...
static function bool IsFacilityLeadRewardNeeded(XComGameState_PointOfInterest POIState)
{
...
static function bool CanFacilityLeadAppear(XComGameState_PointOfInterest POIState)
{
...
static function bool CanGamescomPOIAppear(XComGameState_PointOfInterest POIState)
{
	return false;
}