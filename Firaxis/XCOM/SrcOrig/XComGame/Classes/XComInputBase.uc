...
function bool IsTracking(int cmd)
{
	local int foundIndex;
...
{
	if (Key == 'MouseScrollDown' && Event == IE_Pressed)
	{
		if (XComPlayerController(Outer).Pres.Get2DMovie().IsMouseActive())
		{
			InputEvent(class'UIUtilities_Input'.const.FXS_MOUSE_SCROLL_DOWN);
			return true;
		}


	}
	else if (Key == 'MouseScrollDown' && Event == IE_Released)
	{
		if (XComPlayerController(Outer).Pres.Get2DMovie().IsMouseActive())
		{
			InputEvent(class'UIUtilities_Input'.const.FXS_MOUSE_SCROLL_DOWN, class'UIUtilities_Input'.const.FXS_ACTION_RELEASE);
			return true;
		}

	}
	else if (Key == 'MouseScrollUp' && Event == IE_Pressed)
	{
		if (XComPlayerController(Outer).Pres.Get2DMovie().IsMouseActive())
		{
			InputEvent(class'UIUtilities_Input'.const.FXS_MOUSE_SCROLL_UP);
			return true;
		}


	}
	else if (Key == 'MouseScrollUp' && Event == IE_Released)
	{
		if (XComPlayerController(Outer).Pres.Get2DMovie().IsMouseActive())
		{
			InputEvent(class'UIUtilities_Input'.const.FXS_MOUSE_SCROLL_UP, class'UIUtilities_Input'.const.FXS_ACTION_RELEASE);
			return true;
		}
