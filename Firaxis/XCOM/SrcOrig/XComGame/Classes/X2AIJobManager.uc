...
function EventListenerReturn OnTacticalGameBegin(Object EventData, Object EventSource, XComGameState GameState, Name Event, Object CallbackData)
{
...
function EventListenerReturn OnTacticalGameEnd(Object EventData, Object EventSource, XComGameState GameState, Name Event, Object CallbackData)
{
...
function ResetJobAssignments(int ResetFromIndex, XComGameState NewGameState)
{
	...
	for( JobAssignmentIndex=ResetFromIndex; JobAssignmentIndex < NumAssignments;  ++JobAssignmentIndex )
	{
		...
		if( ObjectID > 0 )
		{
			...
			if (UnitState.GetAIUnitDataID() > 0)
			{
				// Reset job assignment.
				AIUnitData = XComGameState_AIUnitData(NewGameState.ModifyStateObject(class'XComGameState_AIUnitData', UnitState.GetAIUnitDataID()));
				if( AIUnitData.JobIndex != INDEX_NONE ) 
				{
