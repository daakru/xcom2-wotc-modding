class X2Effect_Amplify extends X2Effect_Persistent;

var float BonusDamageMult;
var int MinBonusDamage;
var localized string AmplifyRemoved, AmplifyCountdown;
...
DefaultProperties
{
	EffectName = "AmplifyTarget"
	DuplicateResponse = eDupe_Ignore
	GameStateEffectClass = class'XComGameState_Effect_Amplify'
