...
cpptext 
{
	...
	virtual void SetLDMaxDrawDistance();
...
enum EFilterByDetailType
{
	eFilterByDetail_Low,
	eFilterByDetail_High,
};
...
var() EFilterByDetailType FilterByDetail <ToolTip = "Low detail actors (default) are seen / loaded before high detail actors - which can be shown/hidden or loaded/unloaded as needed by the game.">;
...
struct native TerrainVertexBlending
{
	var() const bool bBlendColor;
	var() const bool bBlendUV;
...
var() const TerrainVertexBlending VertexBlending;
var const bool bNeedsTerrainVertexBlending; // Deprecated
...
var() bool bShouldBeConvertedToInstance;
...
//		bUsePrecomputedShadows=false    // commented out at the behest of Moose - perf hit
	...
	bShouldBeConvertedToInstance=false
}
