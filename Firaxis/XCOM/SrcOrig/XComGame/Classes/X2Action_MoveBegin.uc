...
var protectedwrite PathingInputData  CurrentMoveData;
var protectedwrite PathingResultData CurrentMoveResultData;
...
//We don't allow interrupts to happen until the move begin has finished, if there is an interrupt sequence attached to this move begin it will start at the end of this action
