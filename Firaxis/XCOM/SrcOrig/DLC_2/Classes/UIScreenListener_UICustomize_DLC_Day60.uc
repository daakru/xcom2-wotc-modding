//---------------------------------------------------------------------------------------
//  *********   FIRAXIS SOURCE CODE   ******************
//  FILE:    UIScreenListener_UICustomize_DLC_Day60
//  AUTHOR:  Brit Steiner
//
...
class UIScreenListener_UICustomize_DLC_Day60 extends UIScreenListener;
...
{
	if( BodyPart.DLCName == 'DLC_2' )
	{
		return class'UIUtilities_Text'.static.InjectImage(class'UIUtilities_Image'.const.HTML_HunterIcon, 26, 26, -4) $ " ";
	}
	return "";
