...
/** Optional second state that is used to sample another position in the environment */
var private native transient const pointer OtherState{class FDummyDynamicLightEnvironmentState}; // FIRAXIS ADDITION
...
// FIRAXIS BEGIN
/* The final bounds computed in FDynamicLightEnvironmentState::UpdateOwner.  For debugging */
var BoxSphereBounds FinalBounds;
// FIRAXIS END
...
// FIRAXIS BEGIN
/** Distance required to move before allowing an update of the Static Env. */
var() float StaticUpdateDistanceRequired;
/** Radius size change before allowing an update of the Static Env. */
var() float StaticUpdateSphereRadiusRequired;
// FIRAXIS END
...
cpptext
{
	...
	friend class FDummyDynamicLightEnvironmentState;
...
defaultproperties
{
	...
	StaticUpdateDistanceRequired=25
	StaticUpdateSphereRadiusRequired=10
}
