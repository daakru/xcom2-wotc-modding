...
{
	if(BaseFracturedMeshActor == None) // FIRAXIS REMOVAL - we removed fracskinnedcomponent
	{
		RecyclePart(TRUE);
	}
	else
...
defaultproperties
{
	...
	Begin Object Name=FracturedStaticMeshComponent0
		...
		bUseSkinnedRendering=FALSE  // Firaxis RAM - disabling skinned mesh usage to support mesh painting on fractured static meshes
