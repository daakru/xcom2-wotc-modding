...
var(Projectile)	class<DamageType>	   MyDamageType;  // FIRAXIS - made editable
...
// FIRAXIS BEGIN
// Dom: Remove this function as it doesn't work with archetypes
...
// FIRAXIS BEGIN
// Dom: Remove this function as it uses default.MaxSpeed
...
// FIRAXIS begin: Damage is set dynamically on server upon projectile creation so we need to replicate the amount -tsmith
replication
{
