...
/** Whether to workaround the XAudio2 audio regression in the Feb 2011 XDK */
var		config const	bool							WorkAroundXDKRegression;
...
var bool                                                bOverrideListenerLocation; // FIRAXIS Change
var transient vector                                    vListenerLocationOverride; // FIRAXIS Change
...
// FIRAXIS Change
function OverrideListenerLocation(bool bOverride, optional vector vLoc)
{
	bOverrideListenerLocation = bOverride;
	vListenerLocationOverride = vLoc;
}
