...
var(CascadedShadowMaps) const float CinematicCascadeDistributionExponent;


/** see UDirectionalLightComponent::CascadeTransitionFraction */
var(CascadedShadowMaps) const float CascadeTransitionFraction;
...
defaultproperties
{
	...
	CinematicCascadeDistributionExponent=4
	CascadeTransitionFraction=0.1;

	bCastCompositeShadow=false // FIRAXIS jboswell
	bForceDynamicLight=true // FIRAXIS jboswell
}
