...
cpptext
{
    ...
    static DWORD g_UAnimNodeCurrentSearchTag;
    ...
    static DWORD g_NodesRequiringCacheClear;
    static TArray<UAnimNode*>& GetNodesRequiringCacheClearArray();
