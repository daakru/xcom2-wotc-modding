...
native simulated function ChangeVisibilityAndHide( bool bShow, float fCutdownHeight, float fCutoutHeight ); // FIRAXIS
native function ForceDestroy();  // Should be called in Single Player ONLY, sets bNoDelete to false and calls destroy;  // FIRAXIS

simulated event PostBeginPlay()
{
	SkeletalMeshComponent.bSyncActorLocationToRootRigidBody = false; // FIRAXIS jboswell
...
simulated function OnToggle(SeqAct_Toggle action)
{
	...
	{
		SkeletalMeshComponent.SetHasPhysicsAssetInstance(true); // FIRAXIS jboswell
		SkeletalMeshComponent.WakeRigidBody();
	}
}
...
defaultproperties
{
	...
	Begin Object Class=SkeletalMeshComponent Name=KAssetSkelMeshComponent
		...
		bSyncActorLocationToRootRigidBody=false // FIRAXIS jboswell
	End Object
