						...
						)
{
	...
	TheDecal.BackfaceAngle = BackfaceAngle;
...
function DecalComponent SpawnDecal( MaterialInterface DecalMaterial,
						...
						optional float BackfaceAngle = 0.001, // RAM - Added at SJameson's request. Default value corresponds to slightly less than 90 deg
						optional vector2D InBlendRange = DecalBlendRange,				
						optional int SortOrder = 0 )
{
	local DecalComponent Result;
	...
	// Firaxis BEGIN
	// RAM - adding support for sort order to the dynamically created decals
...
defaultproperties
{
	...
	DecalDepthBias=-0.00001 //FIRAXIS CHANGE decrease depth offset
