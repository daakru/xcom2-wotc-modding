...
// FIRAXIS Begin
final native function	SetAllMotorsLinearPositionDrive(bool bEnableXDrive, bool bEnableYDrive, bool bEnableZDrive, optional SkeletalMeshComponent SkelMesh, optional bool bSkipFullAnimWeightBodies);
final native function	SetAllMotorsLinearDriveParams(float InSpring, float InDamping, float InForceLimit, optional SkeletalMeshComponent SkelMesh, optional bool bSkipFullAnimWeightBodies);
final native function	SetAllBoneSprings(bool bEnableLinear, bool bEnableAngular, float InBoneLinearSpring, float InBoneLinearDamping, float InBoneAngularSpring, float InBoneAngularDamping);
final native function	SetNamedRBBoneSprings(bool bEnable, Array<Name> BoneNames, float InBoneLinearSpring, float InBoneLinearDamping, float InBoneAngularSpring, float InBoneAngularDamping, SkeletalMeshComponent SkelMeshComp);
// FIRAXIS End
