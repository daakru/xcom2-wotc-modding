 ...
 * is returned.
 */
function string GetPlayerAlias()
{
	// TODO: make like gears and have a PlayerAlias variable -tsmith 
	return PlayerName;
}
...
function CopyProperties(PlayerReplicationInfo PRI)
{
	...
	// FIRAXIS addition: must copy our added team flag so that things such as players rejoing hookup correct PRI -tsmith
	PRI.SetTeamType(m_eTeam);
}
...
defaultproperties
{
	...
	m_bReplicateDirtyTeamType=true
}
