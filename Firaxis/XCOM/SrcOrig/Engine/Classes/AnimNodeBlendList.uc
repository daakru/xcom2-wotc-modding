...
function AnimNode GetFirstActiveNode(name classname)
{
	...
	if (Children[ActiveChildIndex].Anim != none)
	{
		if (Children[ActiveChildIndex].Anim.IsA('AnimNodeBlendList'))
			return AnimNodeBlendList(Children[ActiveChildIndex].Anim).GetFirstActiveNode(classname);
		else if (Children[ActiveChildIndex].Anim.IsA('AnimNodeBlendBase'))
			return AnimNodeBlendBase(Children[ActiveChildIndex].Anim).GetFirstActiveNode(classname);
		else if (Children[ActiveChildIndex].Anim.IsA(classname))
			return Children[ActiveChildIndex].Anim;
