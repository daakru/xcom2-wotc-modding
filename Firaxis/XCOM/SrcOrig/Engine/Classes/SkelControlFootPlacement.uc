...
// FIRAXIS ADD - Store the value of the LegLine check so we can use it.
var vector HitLocation;
var int	bHit;
var bool bLockDownFootPlacement;
var vector RootLockDownLocation;
var vector EndLockDownLocation;
// END FIRAXIS

native function LockDownFoot(int BoneIndex, SkeletalMeshComponent SkelComp);
native function UnlockFoot();
