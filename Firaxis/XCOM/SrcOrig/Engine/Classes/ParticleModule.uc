...
/** If TRUE, this module is a ParticleModuleParameterModulator. Used to prevent a need to do a cast. */
var             bool            bIsParamaterModulator;
...
cpptext
{
	...
	/**
	 *	Returns if the module is a module to be used specifically with FSpotParticles (Spot Light particles)
	 */
	virtual UBOOL IsSpotLightTypeDataModule() {return FALSE;}
}
