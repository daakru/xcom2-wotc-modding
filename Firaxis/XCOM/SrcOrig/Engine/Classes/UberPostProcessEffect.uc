...
var(Scene) float SceneExposureAdjustment;
var(Scene) float SceneCurveOutputAdjustment;
...
var(PostprocessAntiAliasing) enum EPostProcessAAType
{
	...
	PostProcessAA_FXAA_AlphaMask<DisplayName=FXAA_AlphaMask>, // Used to propagate the alpha mask past FXAA (Does a green luma)
} PostProcessAAType;
...
defaultproperties
{
	...
	SceneExposureAdjustment=0;
	SceneCurveOutputAdjustment=0;
	BloomWeightSmall=0
	BloomWeightMedium=1
	BloomWeightLarge=0
