...
/** The dimensions that the texture should be when playing */
var const int DecoderSizeX;
var const int DecoderSizeY;
...
/** The movie is becoming visible, reallocate the RT to the appropriate size but don't stop or pause the decoder */
native function GrowRT();
/** The movie is not visible, so reallocate its RT to be 1x1 but don't stop or pause the decoder */
native function ShrinkRT();
/** Pauses the movie. */	
native function Pause();
/** Stops movie playback. */
native function Stop();
/** Closes bink and releases resources */
