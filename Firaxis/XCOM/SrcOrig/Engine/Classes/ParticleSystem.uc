...
var()   bool    bOrientXAxisFullTowardCamera;
...
struct native ParticleSysParam
{
	...
	var()   bool                    EmitterEnable;

//Firaxis RAM
//This needs to initialize these members otherwise the GC will get sad when it tries to cast 0xcccccccc.
	structcpptext
	{		
	FParticleSysParam() : Actor(NULL), Material(NULL), Mesh(NULL), SkeletalMesh(NULL) {}
...
struct native PSCDefaults
{
	var bool    bOverride_InstanceParameters;
	var bool    bOverride_CustomTimeDilation;
	var bool    bOverride_DownsampleThresholdDistance;
	var bool    bOverride_MinDrawDistance;
	var bool    bOverride_LDMaxDrawDistance;
	var bool    bOverride_fCameraOffset;
	var bool    bOverride_HeightPercentageForHeightFog;
	var bool    bOverride_HeightPercentageForFogOfWar;
	var bool    bOverride_DepthPriorityGroup;
	var bool    bOverride_bAllowApproximateOcclusion;
	var bool    bOverride_TranslucentDOFOptions;
	var bool    bOverride_TranslucencySortPriority;
	var bool    bOverride_DrawScale;
	var bool    bOverride_DrawScale3D;
	var bool    bOverride_PrePivot;
	var bool    bOverride_NumVolumeVisibilitySamples;
	var bool    bOverride_LightingBoundsScale;
	var bool    bOverride_bUseBooleanEnvironmentShadowing;
	var bool    bOverride_bDynamic;
	var bool    bOverride_bSynthesizeSHLight;
	var bool    bOverride_bEnabled;
	var bool    bOverride_bTranslucentIgnoreFOW;
	var bool    bOverride_bIgnoreOwnerHidden;
	var bool    bOverride_fMinimumTickRate;

	var()	editinline array<ParticleSysParam>      InstanceParameters<editcondition=bOverride_InstanceParameters>;
	var()   float                                   CustomTimeDilation<editcondition=bOverride_CustomTimeDilation>;
	var()   float                                   DownsampleThresholdDistance<editcondition=bOverride_DownsampleThresholdDistance>;
	var()   float                                   MinDrawDistance<editcondition=bOverride_MinDrawDistance>;
	var()   float                                   LDMaxDrawDistance<editcondition=bOverride_LDMaxDrawDistance>;
	var()   float                                   fCameraOffset <DisplayName=CameraOffset | editcondition=bOverride_fCameraOffset>;
	var()   float                                   HeightPercentageForHeightFog<editcondition=bOverride_HeightPercentageForHeightFog>;
	var()   float                                   HeightPercentageForFogOfWar<editcondition=bOverride_HeightPercentageForFogOfWar>;
	var()   ESceneDepthPriorityGroup                DepthPriorityGroup<editcondition=bOverride_DepthPriorityGroup>;
	var()   bool                                    bAllowApproximateOcclusion<editcondition=bOverride_bAllowApproximateOcclusion>;
	var()   ETranslucentDOFOption                   TranslucentDOFOptions<editcondition=bOverride_TranslucentDOFOptions>;
	var()   bool                                    bTranslucentIgnoreFOW<editcondition=bOverride_bTranslucentIgnoreFOW>;
	var()   bool                                    bIgnoreOwnerHidden<editcondition=bOverride_bIgnoreOwnerHidden>;
	var()   int                                     TranslucencySortPriority<editcondition=bOverride_TranslucencySortPriority>;
	var()   interp	float                           DrawScale <UIMin=0.1 | UIMax=4.0 | editcondition=bOverride_DrawScale>;
	var()   interp	vector                          DrawScale3D<editcondition=bOverride_DrawScale3D>;
	var()   vector                                  PrePivot<editcondition=bOverride_PrePivot>;
	var()   float                                   fMinimumTickRate<editcondition=bOverride_fMinimumTickRate>;

	// Light Environment Variables
	var()   int                                     NumVolumeVisibilitySamples<editcondition=bOverride_NumVolumeVisibilitySamples>;	
	var()   float                                   LightingBoundsScale<editcondition=bOverride_LightingBoundsScale>;
	var()   bool                                    bUseBooleanEnvironmentShadowing<editcondition=bOverride_bUseBooleanEnvironmentShadowing>;
	var()   bool                                    bDynamic<editcondition=bOverride_bDynamic>;
	var()   bool                                    bSynthesizeSHLight<editcondition=bOverride_bSynthesizeSHLight>;
	var()   bool                                    bEnabled<editcondition=bOverride_bEnabled>;
};

var()   PSCDefaults                         ParticleSystemDefaults;
// FIRAXIS End
...
defaultproperties
{
	...
	bOrientXAxisFullTowardCamera=FALSE
