...
enum TextureGroup
{
	...
	TEXTUREGROUP_World1x2<DisplayName=World1x2>,
	TEXTUREGROUP_UI3D<DisplayName=UI3D>,	    	// FIRAXIS addition
	TEXTUREGROUP_WORLDHIGH<DisplayName=WorldHigh>,	// FIRAXIS addition
	TEXTUREGROUP_TextureArray<DisplayName=TextureArray>,
	TEXTUREGROUP_World1x4<DisplayName=World1x4>
};
...
struct native TextureGroupContainer
{
	...
	var()   const bool  TEXTUREGROUP_World1x2;          // FIRAXIS
	var()   const bool  TEXTUREGROUP_UI3D;              // FIRAXIS
	var()   const bool  TEXTUREGROUP_WORLDHIGH;            // FIRAXIS
	var()   const bool  TEXTUREGROUP_TextureArray;      // FIRAXIS
	var()   const bool  TEXTUREGROUP_World1x4;          // FIRAXIS
};
...
var native transient editoronly array<LinearColor> FPSourceArt;


struct native ImportedMipLevel 
{
	var native transient editoronly int SizeX;
	var native transient editoronly int SizeY;
	var native transient editoronly array<Color> Data; 

};

/** We optionally import mip levels from source texture. This is only kept around during import */
var native transient editoronly array<ImportedMipLevel> ImportedMips;

/** Has uncompressed source art? */
var		bool							bIsSourceArtUncompressed;
var     bool                            bImportedWithFPData;
...
/* Cubemap face to use when importing. */
var(Texture)	int								CubemapFace;
...
var(Texture)	editoronly string				SourceFilePath;         // Path to the resource used to construct this texture
var(Texture)	editconst editoronly string				SourceFileTimestamp;    // Date/Time-stamp of the file from the last import
...
native function UpdateResourceScript();
...
cpptext
{
	...
	virtual void CompressNormalsUsingFPData() { };
