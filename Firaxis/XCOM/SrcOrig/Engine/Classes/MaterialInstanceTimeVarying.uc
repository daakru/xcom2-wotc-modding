...
//FIRAXIS ADDITION
struct native BooleanParameterValueOverTime extends ParameterValueOverTime
{
...
var() const array<BooleanParameterValueOverTime>	BooleanParameterValues; //FIRAXIS ADDITION
...
/** Restarts all timers in the material, effectively from time 0 **/
native function Restart();
