...
/** Whether height is determined independently from parent, or not **/
var     const           bool    bAbsoluteHeight;  // FIRAXIS ADDITION
...
defaultproperties
{
	...
	bAbsoluteHeight=FALSE   // FIRAXIS ADDITION
	Height = 0.0            // FIRAXIS ADDITION
	bEnabled=TRUE
	Density=0.00005
	LightBrightness=0.1
