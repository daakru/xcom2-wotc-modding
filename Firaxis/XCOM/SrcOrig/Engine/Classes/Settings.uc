...
// FIRAXIS begin: Added for OnlineGameSearch Property Mapping for PSN/Live/Steam -ttalley
/** Maps an Id value to a name */
struct native IdToNameMapping
{
...
// FIRAXIS end: Added for OnlineGameSearch Property Mapping for PSN/Live/Steam -ttalley
...
struct native SettingsPropertyPropertyMetaData
{
	...
	/** List of Associated Ids for search purposes -ttalley */
	var const array<IdToNameMapping> NamedIds; // FIRAXIS: Added for OnlineGameSearch Property Mapping for PSN/Live/Steam -ttalley
};
