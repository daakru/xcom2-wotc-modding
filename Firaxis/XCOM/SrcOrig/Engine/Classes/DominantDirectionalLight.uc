...
native function SetCastShadows(bool bCastShadows);
...
defaultproperties
{
	...
	Begin Object Class=DominantDirectionalLightComponent Name=DominantDirectionalLightComponent0
        ...
        bAllowPreShadow=TRUE // FIRAXIS - disable preshadows for now
		bCastCompositeShadow=TRUE // FIRAXIS

	    LightingChannels=(BSP=TRUE,Static=TRUE,Dynamic=TRUE,bInitialized=TRUE)
        LightmassSettings=(LightSourceAngle=1)  //Firaxis (default 0.2)
	End Object
