 ...
 */
// FIRAXIS BEGIN: DOM: Don't use this anymore, not compatible with archetypes
/*
...
// FIRAXIS BEGIN
// Dom: remove this because it depends on WeaponProjectiles (removed) and MaxSpeed (not in .static. anymore)
/**
...
simulated function PlayWeaponAnimation( Name Sequence, float fDesiredDuration, optional bool bLoop, optional SkeletalMeshComponent SkelMesh)
{
	...
	`log("PlayWeaponAnimation:"@Sequence @fDesiredDuration @SkelMesh);
...
simulated function FireAmmunition()
{
	...
	switch( WeaponFireTypes[CurrentFireMode] )
	{
		...
		case EWFT_Projectile:
			// FIRAXIS BEGIN -Dom
			// ProjectileFire();
			// TODO: DONT CHECK IN: `assert(0, "FIRAXIS: This fire type is not supported in X-Com, instead use the archetype system.");
			// FIRAXIS END
			break;
...
simulated function ProcessInstantHit(byte FiringMode, ImpactInfo Impact, optional int NumHits)
{
	...
	`log( "ProcessInstantHit!"@Impact.HitActor );
...
// FIRAXIS BEGIN
// DOM: Remove this since it relies on GetProjectileClass() which we're not using anymore in favor
// of archetypes
/*
...
simulated function CustomFire(optional bool bCanDoDamage = true, optional bool HACK_bMindMergeDeathProjectile = false); // FIRAXIS BEGIN/END - MHU - Notify DoDamage Flag
