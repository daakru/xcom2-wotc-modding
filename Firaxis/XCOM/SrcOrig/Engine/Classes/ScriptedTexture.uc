...
var transient bool bFinishedRendering; // FIRAXIS add.  Used to check if we should call the FinishedRendering delegate
...
delegate FinishedRendering(); // FIRAXIS add.  Called after the Render delegate was called

defaultproperties
{
	bFinishedRendering=false; // FIRAXIS add
	bNeedsUpdate=true
