...
// FIRAXIS begin: moved this up from Steamworks so we can configure each write with an update type. steamworks LeaderboardTemplate is convoluted and inaccessible. -tsmith
...
var const ELeaderboardUpdateType LeaderboardUpdateType;
// FIRAXIS end -tsmith
