...
var(DepthOfField) enum EFocusType
{
	...
	FOCUS_Position,
	// uses absolute Y value planes to determine focal points
	FOCUS_AbsolutePlanes
} FocusType;
/** inner focus radius */
...
var(DepthOfField) float NearFocusStart;
/** used when FOCUS_AbsolutePlanes is enabled */
var(DepthOfField) float NearFocusEnd;
/** used when FOCUS_AbsolutePlanes is enabled */
var(DepthOfField) float FarFocusStart;
/** used when FOCUS_AbsolutePlanes is enabled */
var(DepthOfField) float FarFocusEnd;
