...
// Firaxis BEGIN
// JMS - Apply a clamp to delta distance traveled to prevent one-frame glitches like at the
//       beginning of a cinematic
/** 
 *  Clamp the distance traveled per tick to this amount. Useful for eliminating one-frame 
 *  position jumps such as can happen during a cinematic.
 */
var(Spawn)                          float                       MovementClamp;

// RAM - fixing an issue where small values of ParticlesPerUnit could result in erratic 
//		 behavior of this module
/**
 *	Checking this box will tells spawn per units to use an accumulated distance to detemine
 *	when to spawn new particles. This allows very low emission rates / large unit settings
 *	to work properly.
 */
var(Spawn)                          bool                        UseCumulativeDistance;
var                                 float                       TotalDistanceTraveled;
// Firaxis END
...
defaultproperties
{
	...
	MovementClamp=10000.0 // FIRAXIS ADDITION
	UseCumulativeDistance = FALSE
