...
/** Number of Mips to generate in the texture cube. */
var int NumMips;
...
var() const LinearColor ClearColor; // FIRAXIS
...
cpptext
{
	...
	*/
	...
	static UTextureRenderTargetCube* Create(int InSize, EPixelFormat InFormat, FLinearColor InClearColor, UBOOL bOnlyRenderOnce, UBOOL bInNeedsTwoCopies, UObject* InOuter );
}
...
defaultproperties
{
	...
	Format=PF_A8R8G8B8
	ClearColor=(R=0.0,G=1.0,B=0.0,A=1.0) // FIRAXIS
	NumMips=1
}
