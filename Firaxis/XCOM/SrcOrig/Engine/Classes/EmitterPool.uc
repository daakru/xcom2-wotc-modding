...
var protectedwrite ParticleSystemComponent PSCTemplate;
...
protected native final function ParticleSystemComponent GetPooledComponentParameters(ParticleSystem EmitterTemplate, bool bAutoActivate, array<ParticleSysParam> InstanceParams);
 ...
 */
native function ParticleSystemComponent SpawnEmitter(ParticleSystem EmitterTemplate, vector SpawnLocation, optional rotator SpawnRotation, optional Actor AttachToActor, 
											optional Actor InInstigator, optional int MaxDLEPooledReuses, optional bool bInheritScaleFromBase,
											optional array<ParticleSysParam> InstanceParams, //Firaxis RAM - support for overriding instance parameters
										    optional float WarmupTime = -1.0f, //Firaxis RAM - allows effects to properly behave after loading
										    optional vector Scale ); //Firaxis RAM - allows effects to be scaled
