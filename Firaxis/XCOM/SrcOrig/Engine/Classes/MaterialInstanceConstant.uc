...
//FIRAXIS ADDITION
struct native BooleanParameterValue
{
	var() name	ParameterName;
...
var() const array<BooleanParameterValue>	BooleanParameterValues; //FIRAXIS ADDITION
...
cpptext
{
	...
	*/
	...
	virtual void PostDuplicateWithSource(UObject* SourceObject);
...
native function CopyParametersFromMIC(MaterialInstanceConstant Source);
