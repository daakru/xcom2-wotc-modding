...
enum EMaterialUsage
{
	...
	MATUSAGE_APEXMesh,
	MATUSAGE_Terrain,
	MATUSAGE_Landscape_DEPRECATED,
	MATUSAGE_DoorsWindows, // FIRAXIS ADDITION
	MATUSAGE_MovementGrid, // FIRAXIS ADDITION
	MATUSAGE_StaticMesh, // FIRAXIS ADDITION
	MATUSAGE_DebrisIM // FIRAXIS ADDITION
};
...
cpptext
{
	...
	*/
	 ...
	 */
	virtual UBOOL GetUsageByFlag(EMaterialUsage Usage) PURE_VIRTUAL(UMaterialInterface::GetUsgeByFlag, return FALSE;);

	/**
	* Allocates a new material resource
	* @return	The allocated resource
	*/
	virtual FMaterialResource* AllocateResource(UBOOL bInOverrideParentTwoSided = FALSE) PURE_VIRTUAL(UMaterialInterface::AllocateResource,return NULL;);
	...
	*/
	...
	/**
	* Sets the given static switch parameter
	...
	*/
	virtual UBOOL SetStaticSwitchParameterValue(FName ParameterName, UBOOL &InValue)
		PURE_VIRTUAL(UMaterialInterface::SetStaticSwitchParameterValue, return FALSE;);
	...
	*/
	...
	//had to manually add this to native because unreal script does not allow out bool parameters
	virtual UBOOL GetBooleanParameterValue(FName ParameterName,UBOOL& OutValue);
...
var(Mobile, Specular) float MobileRoughness<EditCondition=bUseMobileSpecular>;
