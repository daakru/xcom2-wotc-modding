...
// Firaxis Begin
// RAM - this enum used to have significance, but is no longer used normally. It is still used to support modding / SoundCues because the cooked data was already locked
//		 before we could change this to a name. So, mods are limited to 255 character templates that can be used as narrative portraits / speakers.
enum EXComSpeakerType
{
	eSpeaker_Dummy
};
// Firaxis End
...
var( XCom )	localized string							SpokenText<ToolTip=The phonetic version of the dialog.>;  // FIRAXIS change - moved to XCom group
...
// FIRAXIS Begin
var(XCom) EXComSpeakerType eSpeaker<ToolTip = Deprecated, use SpeakerTemplate instead>;

var(XCom)						FaceFXAnimSet							FaceFXAnimSetRef;
/** Name of the FaceFX Group the animation is in */
var(XCom)						string									FaceFXGroupName;
/** Name of the FaceFX Animation */
var(XCom)						string									SpeakerTemplate<ToolTip = Character template name of the speaker for this dialog | DynamicList = "SpeakerTemplate">;
