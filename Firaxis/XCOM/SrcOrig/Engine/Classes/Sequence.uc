...
#define PREFAB_SEQCONTAINER_NAME	TEXT("Prefabs")
	...
	*/
	...
	void DetermineIfOpsAreGameState(); // scans ops to determine if they are part of a game state stream or not (affects coloring and editor)
...
native function string GetLevelName();    //  FIRAXIS ADDITION
