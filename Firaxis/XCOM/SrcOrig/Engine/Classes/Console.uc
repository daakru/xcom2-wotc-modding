...
{
// FIRAXIS BEGIN jboswell/cotoole: Console support
	// No console input on retail builds
	if( !class'Engine'.static.IsConsoleAllowed() /* && Class'WorldInfo'.Static.IsConsoleBuild()*/)
		return false;
// FIRAXIS END
...
state Typing
{
	...
	function bool InputKey( int ControllerId, name Key, EInputEvent Event, float AmountDepressed = 1.f, bool bGamepad = FALSE )
	{
		...
		// FIRAXIS sbatista: Fixing tab autocomplete
