...
/** Has this op been converted to work with the replay system? Might not need anything done, but still needs to be looked at*/
var const bool bConvertedForReplaySystem;

/** Can this op be executed as part of a normal unreal style sequence*/
var const bool bCanBeUsedForNormalSequence;

/** Can this op be executed as part of an X2 gameplay sequence*/
var const bool bCanBeUsedForGameplaySequence;
...
/** True if this op is part of a gameplay op stream */
var const bool bIsPartOfGameplayStream;
...
defaultproperties
{
	...
	bConvertedForReplaySystem=false
	bCanBeUsedForNormalSequence=true
	bCanBeUsedForGameplaySequence=false
}
