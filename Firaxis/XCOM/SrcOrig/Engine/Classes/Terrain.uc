...
// Firaxis BEGIN
// RAM - did a search, asked around. There didn't appear to be an existing enum to use for this so we'll define it here.
enum ColorChannel
{
	ColorChannel_Red,
	ColorChannel_Green,
...
struct TerrainLayer
{
	...
	/** 
	 *  Blend gradients between layers are perturbed by a noise texture, this value selects
	 *  which channel in that texture to use for this terrain layer. This allows the appearance
	 *  of layer blends to be adjusted.
	 */
	var() ColorChannel	BlendNoiseChannel;

	/** 
	 *  Adjusts how frequently the terrain blend noise texture will be tiled across the
	 *  entire terrain.
	 */
	var() float         BlendNoiseMappingScale;
	// Firaxis END
	...
	structdefaultproperties
	{
		...
		// Firaxis BEGIN
		// RAM - added to support better looking terrain blending
		BlendNoiseChannel=ColorChannel_Red
		BlendNoiseMappingScale=128.0
		// Firaxis END
	}
};
...
defaultproperties
{
	...
	NormalMapLayer=-1
	NumPatchesX=256 // FIRAXIS jboswell
	NumPatchesY=256 // FIRAXIS jboswell
	MaxComponentSize=128 // FIRAXIS jboswell
	...
	bNoDelete=True
	bHidden=False
	MaxTesselationLevel=1 // FIRAXIS jboswell
	...
	bCastShadow=True
	bCastDynamicShadow=false // FIRAXIS jboswell
