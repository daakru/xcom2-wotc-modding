...
var() editfixedsize array<EmitterDynamicParameter>	DynamicParams1;
...
cpptext
{
	...
	FORCEINLINE FLOAT GetParameterValue(FEmitterDynamicParameter& InDynParams, FBaseParticle& Particle, FParticleEmitterInstance* Owner, class FRandomStream* InRandomStream)
	{
		...
		//Firaxis Change, dbaker, using ptr to get rid of LHS
		FLOAT *pTimeValue = InDynParams.bUseEmitterTime ? &Owner->EmitterTime : &Particle.RelativeTime;
		...
		{
			DistributionValue = InDynParams.ParamValue.GetValuePTR(pTimeValue, Owner->Component, InRandomStream);
		}
		//End Firaxis Change
	...
	{
		//Firaxis Change, dbaker, using ptr varient to get rid of LHS
		return InDynParams.ParamValue.GetValuePTR(InDynParams.bUseEmitterTime ? &Owner->EmitterTime : &Particle.RelativeTime, Owner->Component, InRandomStream);
		//End Firaxis Change
	}
...
defaultproperties
{
	...
	Begin Object Class=DistributionFloatConstant Name=DistributionParam5
	End Object
	DynamicParams1(0)=(ParamName="",bUseEmitterTime=false,ValueMethod=EDPV_UserSet,ParamValue=(Distribution=DistributionParam5))
	Begin Object Class=DistributionFloatConstant Name=DistributionParam6
	End Object
	DynamicParams1(1)=(ParamName="",bUseEmitterTime=false,ValueMethod=EDPV_UserSet,ParamValue=(Distribution=DistributionParam6))
	Begin Object Class=DistributionFloatConstant Name=DistributionParam7
	End Object
	DynamicParams1(2)=(ParamName="",bUseEmitterTime=false,ValueMethod=EDPV_UserSet,ParamValue=(Distribution=DistributionParam7))
	Begin Object Class=DistributionFloatConstant Name=DistributionParam8
	End Object
	DynamicParams1(3)=(ParamName="",bUseEmitterTime=false,ValueMethod=EDPV_UserSet,ParamValue=(Distribution=DistributionParam8))
}
