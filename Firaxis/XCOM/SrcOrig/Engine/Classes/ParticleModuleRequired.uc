...
/** 
 *	if not empty, can be used with an instance parameter to modify EmitterDuration
 */
var(Duration)                       string                      DurationMultiplierName;
...
/** 
 *	if not empty, can be used with an instance parameter to modify EmitterDelay
 */
var(Delay)                      string                      DelayMultiplierName;
...
enum EParticleDownsampleLevel
{
	PDOWNSAMPLE_Low,
	PDOWNSAMPLE_High
};

/** Only particles of equal or higher level the SystemSettings.DownsampleLeve will Downsample */
var(Rendering)									EParticleDownsampleLevel	DownsampleLevel;

var(Rendering)									bool						bForceRenderNonHalfRes;

var(Rendering)									bool						bHideInSceneCaptures;
...
defaultproperties
{
	...
	bForceRenderNonHalfRes=FALSE

	bHideInSceneCaptures=FALSE

	DownsampleLevel=PDOWNSAMPLE_Low
}
