...
/** Decal will be reattached by the primitive. Use to prevent any hasting resource deletion/removal by the decal manager */
var transient bool bReattachingDueToPrimitive; // FIRAXIS

/** Decal will be reattached by the primitive. Use to prevent any hasting resource deletion/removal by the decal manager */
var transient bool bForceComputeReceivers; // FIRAXIS
...
public:
	 ...
	 */
	void CaptureDecalState(class FDecalState* DecalState, UPrimitiveComponent* Receiver = NULL) const;
	...
	*/
	...
	virtual void ReattachBasedOnSettings();
...
defaultproperties
{
	...
	HitNodeIndex=-1
	HitLevelIndex=-1
	DepthBias=-0.00001 //FIRAXIS CHANGE to decrease decal offset
	...
	TranslucentDOFOptions=eTO_AlwaysDOF
}
