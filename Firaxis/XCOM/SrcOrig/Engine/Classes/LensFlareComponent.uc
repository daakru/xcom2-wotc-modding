...
/** Should the Lens Flare render with Downsampling */
var(Rendering)						float					DownsampleThresholdScreenFraction;
var(Rendering)                      float                   DownsampleThresholdDistance;
// FIRAXIS End
...
defaultproperties
{
	...
	DownsampleThresholdScreenFraction=0.0
	DownsampleThresholdDistance=0.0

	SourceColor=(R=1.0,G=1.0,B=1.0,A=1.0)

	bVisibleForMobile=false;

	TranslucentDOFOptions=eTO_NeverDOF
}
