...
/** General purpose tag */
var(Particle)               name                        Tag;
/** Emitter has to be enabled via EmitterToggle ParticleSysParams, defaults to disabled */
var(Particle)               bool                        ParameterEnabled;
...
/** Does this emitter need OrthoDepth Set for Weather */
var(Particle)               bool                        bNeedsOrthoDepthForWeather;

/** If TRUE, then show only this emitter in the editor */
var transient				bool						bIsSoloing;

/** Average Wind speed applied to all particles active in the emitter */
var transient				float						AverageParticleWindSpeed;
...
cpptext
{
	...
	*/
	...
	UBOOL AllLODsAreDisabled() const;
}
...
defaultproperties
{
	...
	bNeedsOrthoDepthForWeather=false
